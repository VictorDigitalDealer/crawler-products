import { getMenuParser, getCategoryParser, } from "../../infrastructure/scrapers/menuParsers.js";
...
export async function crawlOnePage(siteId, siteConfig) {
    console.log("\n====================================");
    ...
    const productsForDb = products.map((p) => ProductMapper.toDb({ p, shop: category.shopId, category: category.url }));
