import { ProductComparisonToSave } from "../../types.js";
import { prisma } from "../PrismaClient.js";

type SaveProductComparisonsToDbArgs = {
  comparisons: ProductComparisonToSave[];
};

export async function saveProductComparisonsToDb({
  comparisons,
}: SaveProductComparisonsToDbArgs) {
  ...
  try {
    console.log(
      `Guardando ${data.length} comparaciones en la base de datos...`,
    );
